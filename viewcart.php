   				...
   				<div class="col-md-8 col-lg-8">
					...
					<?php
							...
							for ($i=0; $i<count($_SESSION['session_cart']); $i++ ) {
								...
								$item_amount = $items[0]['price']*$_SESSION['session_cart'][$i][1];		//cost of item with quantity
								...
								?>
									<tr bgcolor= "#EFEFEF">
										...
										<td align="right"><?php echo( sprintf("%01.2f", $items[0]['price'] * $quantity ) ); ?> VND</td>
										<td width="10">&nbsp;</td>
							...
							<tr>
								...
								<td width="10">&nbsp;</td>
								<td align="right" bgcolor="#DCDBDB"><strong>Total <?php echo($items[0]['currency']); ?>&nbsp;<?php echo(sprintf("%01.2f", $total_price)); ?> VND</strong></td>
